...
class GK_School_Dashboard {
    ...
    public static function render_dashboard_shortcode() {
        ...
        <style>
            ...
            /* کلاس‌ها به صورت گرید چندستونه فشرده و شیک کنار هم */
            @media (max-width: 520px) { #gk-classes-list { grid-template-columns: 1fr !important; } }
            #gk-classes-list {
            ...
            /* استایل دکمه‌های تمام آیکونی جدول */
        ...
        <div class="gk-school-wrap" id="gk-school-app">
            ...
            <div id="gk-edit-student-modal" style="display:none; position:fixed; top:0; left:0; width:100%; height:100%; background:rgba(15,23,42,0.6); z-index:999999; backdrop-filter:blur(4px);">
                <div style="max-width:480px; margin:80px auto; background:#fff; border-radius:24px; padding:26px; box-shadow:0 20px 40px rgba(0,0,0,0.2); direction:rtl; text-align:right;">
                    <div style="display:flex; justify-content:space-between; align-items:center; margin-bottom:18px; border-bottom:1.5px solid #f1f5f9; padding-bottom:12px;">
                        ...
                        <button type="button" onclick="jQuery('#gk-edit-student-modal').fadeOut(200);" style="background:none; border:none; font-size:20px; cursor:pointer; color:#64748b;">✕</button>
                    </div>
                    ...
                    <div style="display:flex; gap:10px;">
                        ...
                        <button type="button" onclick="jQuery('#gk-edit-student-modal').fadeOut(200);" style="background:#f1f5f9; border:1.5px solid #cbd5e1; border-radius:12px; padding:0 18px; font-weight:bold; font-size:13px; cursor:pointer;">
                            انصراف
                        </button>
                    </div>
                </div>
            ...
            <!-- مدال ویرایش اطلاعات کلاس و مربی -->
            <!-- ۱. پنجره لوکس مدیریت و جزئیات کلاس (دسته‌بندی‌شده و استاندارد) -->
                        <!-- ۱. پنجره پاپ‌آپ ایجاد کلاس جدید -->
            <div id="gk-new-class-modal" class="gk-modal-backdrop" style="display:none; position:fixed; top:0; left:0; width:100%; height:100%; background:rgba(15,23,42,0.7); z-index:9999999; backdrop-filter:blur(6px); direction:rtl; text-align:right;">
                <div class="gk-modal-card" style="max-width:480px; margin:50px auto; background:#ffffff; border-radius:26px; padding:26px; box-shadow:0 25px 60px rgba(0,0,0,0.3); border:2px solid #e2e8f0; max-height:90vh; overflow-y:auto;">
                    ...
                    <div style="display:flex; justify-content:space-between; align-items:center; margin-bottom:18px; border-bottom:2px solid #f1f5f9; padding-bottom:14px;">
                        ...
                        <button type="button" onclick="jQuery('#gk-new-class-modal').fadeOut(200);" style="background:#f1f5f9; border:none; width:34px; height:34px; border-radius:50%; font-size:16px; cursor:pointer; color:#64748b; font-weight:900; display:flex; align-items:center; justify-content:center;">✕</button>
                    </div>
                    ...
                    <div style="display:flex; flex-direction:column; gap:14px;">
                        ...
                        <div style="display:flex; gap:10px; margin-top:8px; border-top:1.5px solid #f1f5f9; padding-top:16px;">
                            ...
                            <button type="button" onclick="jQuery('#gk-new-class-modal').fadeOut(200);" style="background:#f8fafc; color:#64748b; border:1.5px solid #cbd5e1; padding:12px 20px; border-radius:12px; font-size:13px; font-weight:800; cursor:pointer;">
                                انصراف
                            </button>
                        </div>
                    </div>
...
<div id="gk-class-info-modal" class="gk-modal-backdrop" style="display:none; position:fixed; top:0; left:0; width:100%; height:100%; background:rgba(15,23,42,0.7); z-index:9999999; backdrop-filter:blur(6px); direction:rtl; text-align:right;">
                <div class="gk-modal-card" style="max-width:540px; margin:30px auto; background:#ffffff; border-radius:26px; padding:24px 26px; box-shadow:0 25px 60px rgba(0,0,0,0.3); border:2px solid #e2e8f0; max-height:90vh; overflow-y:auto;">
                    ...
                    <div style="display:flex; justify-content:space-between; align-items:center; margin-bottom:18px; border-bottom:2px solid #f1f5f9; padding-bottom:14px;">
                        ...
                        <button type="button" onclick="jQuery('#gk-class-info-modal').fadeOut(200);" style="background:#f1f5f9; border:none; width:34px; height:34px; border-radius:50%; font-size:16px; cursor:pointer; color:#64748b; font-weight:900; display:flex; align-items:center; justify-content:center;">✕</button>
                    </div>
                    ...
                    <div style="display:flex; gap:8px; border-top:1.5px solid #f1f5f9; padding-top:14px; align-items:center;">
            ...
            <div id="gk-edit-class-modal" style="display:none; position:fixed; top:0; left:0; width:100%; height:100%; background:rgba(15,23,42,0.6); z-index:999999; backdrop-filter:blur(4px);">
                <div style="max-width:460px; margin:80px auto; background:#fff; border-radius:24px; padding:26px; box-shadow:0 20px 40px rgba(0,0,0,0.2); direction:rtl; text-align:right;">
                    <div style="display:flex; justify-content:space-between; align-items:center; margin-bottom:18px; border-bottom:1.5px solid #f1f5f9; padding-bottom:12px;">
                        <h3 style="margin:0; font-size:17px; color:#1e293b;">✏️ ویرایش مشخصات کلاس و مربی</h3>
                        <button type="button" onclick="jQuery('#gk-edit-class-modal').fadeOut(200);" style="background:none; border:none; font-size:20px; cursor:pointer; color:#64748b;">✕</button>
                    </div>
                    ...
                    <div style="display:flex; gap:10px;">
                        ...
                        <button type="button" onclick="jQuery('#gk-edit-class-modal').fadeOut(200);" style="background:#f1f5f9; border:1.5px solid #cbd5e1; border-radius:12px; padding:0 18px; font-weight:bold; font-size:13px; cursor:pointer;">
                            انصراف
                        </button>
                    </div>
                </div>
            ...
            <div class="gk-school-tabs-grid">
                ...
                <div class="gk-panel-box">
                    <div class="gk-box-head" style="display:flex; justify-content:space-between; align-items:center;">
                        ...
                        <button type="button" class="gk-btn-primary" onclick="jQuery('#gk-new-class-modal').fadeIn(200); jQuery('#gk-new-class-name').focus();" style="padding:8px 14px; font-size:12.5px; border-radius:12px; display:inline-flex; align-items:center; gap:6px; cursor:pointer;">
                            <span>✨</span>
                ...
                <div class="gk-panel-box">
                    ...
                    <div class="gk-box-head">
                        <h3>🎓 دانش‌آموزان و نوآموزان</h3>
                        <span style="font-size:12px; color:#64748b; font-weight:bold;"><strong id="gk-visible-count"><?php echo $total_students; ?></strong> نفر</span>
                    </div>

                    <!-- تب‌های فیلتر سریع -->
                    <div class="gk-filter-tabs" id="gk-filter-tabs-container">
                        <button type="button" class="gk-filter-btn active" id="gk-filter-btn-all" data-filter="all" onclick="gkFilterClass('all');">
                            🌟 همه دانش‌آموزان (<span id="gk-filter-total-count"><?php echo $total_students; ?></span>)
                        </button>
                        <?php foreach ($classes as $c): 
                            $c_count = $class_counts[$c->id] ?? 0;
                        ?>
                            <button type="button" class="gk-filter-btn" id="gk-filter-btn-<?php echo $c->id; ?>" data-filter="<?php echo $c->id; ?>" onclick="gkFilterClass(<?php echo $c->id; ?>);">
                                🏫 <span class="filter-btn-name"><?php echo esc_html($c->name); ?></span> (<span class="filter-btn-count"><?php echo $c_count; ?></span>)
                            </button>
                        <?php endforeach; ?>
                    </div>

                    <!-- فرم افزودن کودک -->
                    <div id="gk-add-student-box" style="background:#f8fafc; border:1.5px solid #e2e8f0; padding:16px; border-radius:18px; margin-bottom:20px; <?php echo (empty($classes) || $is_full) ? 'display:none;' : ''; ?>">
                        <strong style="font-size:13.5px; display:block; margin-bottom:10px; color:#1e293b;">+ ثبت دانش‌آموز جدید با شماره همراه بله:</strong>
                        <div style="display:grid; grid-template-columns:1.4fr 0.8fr 1fr 1.2fr auto; gap:8px; align-items:flex-end;">
                            <div>
                                <label style="font-size:12px; font-weight:bold; color:#475569;">نام و نام خانوادگی:</label>
                                <input type="text" id="gk-student-name" placeholder="مثلاً: آرتین رضایی" style="width:100%; padding:8px 10px; border-radius:10px; border:1.5px solid #cbd5e1; font-size:12.5px; box-sizing:border-box;">
                            </div>
                            <div>
                                <label style="font-size:12px; font-weight:bold; color:#475569;">سن:</label>
                                <select id="gk-student-age" style="width:100%; padding:8px 6px; border-radius:10px; border:1.5px solid #cbd5e1; font-size:12.5px; box-sizing:border-box;">
                                    <option value="4">۴ ساله</option>
                            ...
                            <div>
                                <label style="font-size:12px; font-weight:bold; color:#475569;">کلاس:</label>
                                <select id="gk-student-class" style="width:100%; padding:8px 6px; border-radius:10px; border:1.5px solid #cbd5e1; font-size:12.5px; box-sizing:border-box;">
                                    <?php foreach ($classes as $c): ?>
                                        <option value="<?php echo $c->id; ?>"><?php echo esc_html($c->name); ?></option>
                                    <?php endforeach; ?>
                                </select>
                            ...
                            <div>
                                <label style="font-size:12px; font-weight:bold; color:#475569;">شماره همراه مادر (بله):</label>
                                <input type="text" id="gk-student-phone" placeholder="0912..." style="width:100%; padding:8px 10px; border-radius:10px; border:1.5px solid #cbd5e1; font-size:12.5px; box-sizing:border-box;">
                            </div>
                            <div>
                                <button type="button" class="gk-btn-primary" id="gk-btn-add-student" style="padding:9px 14px; font-size:12.5px; white-space:nowrap;">
                                    ثبت دانش‌آموز 🎯
                                </button>
                            </div>
                        </div>
        ...
        function gkOpenClassInfoModal(classId) {
            ...
            jQuery('#gk-class-info-modal').fadeIn(200);
        ...
        function gkTriggerEditFromModal() {
            if (!gkCurrentModalClassId) return;
            jQuery('#gk-class-info-modal').fadeOut(150);
            var card = jQuery('#gk-class-row-' + gkCurrentModalClassId);
            if (card.length) {
                ...
                jQuery('#gk-edit-class-modal').fadeIn(200);
            }
        }
        ...
        function gkFilterClass(classId) {
            ...
            jQuery('.gk-filter-btn').removeClass('active');
            jQuery('.gk-class-card-item').removeClass('active-class');

            if (classId === 'all') {
                jQuery('.gk-filter-btn[data-filter="all"]').addClass('active');
                jQuery('.gk-student-row').fadeIn(150);
                jQuery('#gk-visible-count').text(jQuery('.gk-student-row').length);
            } else {
                jQuery('.gk-filter-btn[data-filter="' + classId + '"]').addClass('active');
                jQuery('#gk-class-row-' + classId).addClass('active-class');

                jQuery('.gk-student-row').hide();
                var matched = jQuery('.gk-student-row[data-class-id="' + classId + '"]');
                matched.fadeIn(150);
                jQuery('#gk-visible-count').text(matched.length);
        ...
        function gkOpenEditStudent(id, name, age, classId, phone) {
            ...
            jQuery('#gk-edit-student-modal').fadeIn(200);
        }
        ...
        jQuery(document).ready(function($) {
            // جلوگیری از رفرش ناخواسته با زدن دکمه اینتر
            ...
            // ۱. ثبت دانش‌آموز جدید بدون رفرش و با حفظ دقیق فیلتر کلاس
            $('#gk-btn-add-student').on('click', function(e) {
                ...
                $.post('<?php echo $ajax_url; ?>', {
                    ...
                    btn.text('ثبت دانش‌آموز 🎯').prop('disabled', false);
                    if (res.success && res.data) {
                        ...
                        // اگر فیلتر فعال با کلاس ثبت شده منطبق نیست، سطر را مخفی کن، در غیر این صورت نمایش بده
                        var isVisible = (gkActiveFilter === 'all' || gkActiveFilter == d.class_id);
                        var displayStyle = isVisible ? '' : 'display:none;';

                        var newRowHtml = `
                            <tr class="gk-student-row" data-class-id="${d.class_id}" id="gk-student-row-${d.id}" style="${displayStyle} background-color:#bbf7d0;">
                                <td>
                        ...
                        var filterTabCount = $('#gk-filter-btn-' + d.class_id + ' .filter-btn-count');
                        if (filterTabCount.length) {
                            var curFC = parseInt(filterTabCount.text()) || 0;
                            filterTabCount.text(curFC + 1);
                        }
                    } else {
            ...
            $('#gk-btn-add-class').on('click', function(e) {
                ...
                $.post('<?php echo $ajax_url; ?>', {
                    ...
                    if (res.success && res.data) {
                        ...
                        // بروزرسانی فیلتر سریع بالای جدول
                        var filterBtn = '<button type="button" class="gk-filter-btn" id="gk-filter-btn-' + d.id + '" data-filter="' + d.id + '" onclick="gkFilterClass(' + d.id + ');">🏫 ' + d.name + ' (0)</button>';
                        $('#gk-filter-tabs-container').append(filterBtn);
