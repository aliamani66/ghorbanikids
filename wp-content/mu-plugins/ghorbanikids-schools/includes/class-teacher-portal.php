...
class GK_Teacher_Portal {
    ...
    public static function render_teacher_portal() {
        ...
        <div class="gk-teacher-wrap">
            ...
            <div class="gk-tab-pane" id="tab-podium">
                <div class="gk-card-box">
                    <div style="border-bottom:2px dashed #e0e7ff; padding-bottom:12px; margin-bottom:18px;">
                        <h2 style="font-size:18px; font-weight:900; margin:0; color:#1e1b4b;">🏆 تابلوی قهرمانان و لیگ امتیازی کل کلاس</h2>
                        <p style="font-size:13px; color:#64748b; margin:4px 0 0 0;">رتبه‌بندی زنده کودکان بر اساس مجموع امتیازات کسب‌شده در تمام بازی‌ها</p>
                    </div>
        ...
        jQuery(document).ready(function($) {
            ...
            $('#gk-btn-submit-create-league').on('click', function(e) {
                ...
                if (!title) { alert('لطفاً عنوان مسابقه را وارد کنید.'); return; }
                if (selectedGames.length === 0) { alert('لطفاً حداقل یک بازی را برای این مسابقه انتخاب نمایید.'); return; }
        ...
        function gkDeleteExam(examId) {
            if (!confirm('آیا از حذف این آزمون کلاسی اطمینان دارید؟')) return;
            jQuery.post('<?php echo $ajax_url; ?>', {
                ...
                if (res.success) {
                    ...
                    alert(res.data || 'خطا در حذف آزمون.');
                }
            });
        }
        function gkDeleteLeague(leagueId) {
            jQuery.post('<?php echo $ajax_url; ?>', {
                ...
                if (res.success) {
                    ...
                    alert(res.data || 'خطا در حذف مسابقه.');
                }
            });
        }
